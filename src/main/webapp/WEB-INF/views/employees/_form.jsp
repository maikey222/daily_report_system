...
<lable for="${AttributeConst.EMP_CODE.getValue()}">社員番号</lable><br />
<input type="text" name="${AttributeConst.EMP_CODE.getValue()}" value="${employee.code}" />
<br /><br />

<lable for="${AttributeConst.EMP_NAME.getValue()}">氏名</lable><br />
<input type="text" name="${AttributeConst.EMP_NAME.getValue()}" value="${employee.name}" />
<br /><br />

<lable for="${AttributeConst.EMP_PASS.getValue()}">パスワード</lable><br />
<input type="password" name="${AttributeConst.EMP_PASS.getValue()}" />
<br /><br />

<lable for="${AttributeConst.EMP_ADMIN_FLG.getValue()}">権限</lable><br />
